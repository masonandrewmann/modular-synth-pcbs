...
//          setVoltage(DAC1, 1, 1, velocity<<5);  // DAC1, channel 1, gain = 2X
            setVoltage(DAC1, 1, 0, velocity<<5);  
        }
...
#define NOTE_SF 38.447f // This value can be tuned if CV output isn't exactly 1V/octave

void commandNote(int noteMsg, int outChannel) {
